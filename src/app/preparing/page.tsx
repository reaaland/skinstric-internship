  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-[#FCFCFC] text-[#1A1B1C]">
      <Image
        ...
        height={740}
        aria-hidden="true"
        className="pointer-events-none absolute left-1/2 top-1/2 size-110 max-w-none -translate-x-1/2 -translate-y-1/2 object-contain sm:size-[min(72.3vh,90vw,740px)]"
      />
